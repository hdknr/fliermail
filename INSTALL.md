# **fliermail** Installation Instructions

This section contains information about 
how to download and install **fliermail** in your system. 
...
inside the ** fliermail ** distribution package. 
...
URL is https://github.org/hdknr/fliermail


## Install

To install **fliermail** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.org/hdknr/fliermail

The above command will install the latest development release of **fliermail**.
